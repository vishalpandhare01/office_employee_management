...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\employee management project\office_emp_project\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\employee management project\office_emp_project\env\Scripts\deactivate.nu'
